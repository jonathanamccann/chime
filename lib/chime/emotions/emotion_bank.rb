module EmotionBank
  ...
  # and groups them into a hash where the keys are the 7 available
	...
	def self.get_term_emotions
		{"negative"=>["abhor", "abhorr", "abhorrence", "abomin", "abominate",
			...
			"wrath", "wrathful", "wrathfully", "wroth", "wrothful","affright", "afraid", "alarm", "alarmed", "alert",
			...
			"unassertiveness", "uneasili", "uneasily", "unkind", "unsur", "unsure","abhorr",
			...
			"yucky", "aggriev", "aggrieve", "attrit", "attrition", "bad", "bereav",
			...
			"world-weariness", "world-weary", "wretch", "wretched"],
          		 ...
          		 "positive"=>["admir", "admirable", "admirably", "admiration", "admire",
			...
			"schadenfreud", "schadenfreude", "self-complac", "self-
			...
			"warmheart", "warmhearted", "warmheartedness", "warmth",
			"with_empathi", "with_empathy", "with_happi", "with_happiness", "with_prid",
			"with_pride", "with_sympathi", "with_sympathy", "worship",
			"worshipful", "zeal", "zealous", "zest", "zestfulness",            "admir",
			...
			"awe", "awed", "awestricken", "awestruck", "baffl", "baffle", "beat",
